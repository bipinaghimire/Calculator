...
button_add=Button(main, text='+', padx=41, pady=20, fg='white', bg='black', command=button_add)
...
button_equal=Button(main, text='=', padx=41, pady=20, fg='white', bg='black', command=button_equal)
button_clear=Button(main, text='Clear', padx=75, pady=20, fg='white', bg='black', command=button_clear)
button_del=Button(main, text='Del', padx=33, pady=20, fg='white', bg='black',command=button_delete)
button_power=Button(main, text='^', padx=38, pady=20, fg='white', bg='black',command=button_power)
